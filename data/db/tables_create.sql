...
CREATE TABLE companies_platform_families (
	company_id int NOT NULL REFERENCES companies(id),
	platform_family_id int NOT NULL REFERENCES platform_families(id),
	company_role_id int NOT NULL REFERENCES company_roles(id),
	PRIMARY KEY (company_id, platform_family_id, company_role_id)
);
...
CREATE TABLE listings (
	id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
	board_host_id int NOT NULL REFERENCES board_hosts(id),
	native_id text NULL,
	url text NOT NULL,
	title text NOT NULL,
	body text NULL,
