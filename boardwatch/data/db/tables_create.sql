...
CREATE TABLE user_set_settings (
	user_id int NOT NULL PRIMARY KEY REFERENCES users(id),
	notification_frequency_min int NOT NULL,
	notification_email_is_html boolean NOT NULL
);
...
CREATE TABLE listings_platforms (
	...
	is_matched_via_body_text boolean NOT NULL,
